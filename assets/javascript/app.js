...
// Questions array
var questions = [{
    question: "What is the stage name of the rapper with the birth name Marshall Mathers?",
    answerList: ["Eminem", "M & M", "Kit Kat", "Snickers"],
    answer: 0
},{
    question: "What was the name of JAy-Z's first album?",
    answerList: ["The Black Album", "American Gangster", "Reasonable Doubt", "The Blueprint"],
    answer: 2
},{
    question: "Which of these is not a 50 Cent album?",
    answerList: ["Get Rich or Die Tryin", "Massacre", "Beg for Mercy", "Chicken and Beer"],
    answer: 3
},{
    question: "Dr. Dre released what type of music equipment?",
    answerList: ["Microphones", "Cables", "Mixers", "Headphones"],
    answer: 3
},{
    question: "What city was 2pac shot in?",
    answerList: ["Los Angeles", "Las Vegas", "New York", "Baltimore"],
    answer: 1
},{
    question: "Which of the following is NOT an alias of Notorious BIG?",
    answerList: ["Big Bunny", "Big Poppa", "Frank White", "Biggie Smalls"],
    answer: 0
},{
    question: "What city is considered the home of hip hop?",
    answerList: ["Washington D.C", "Los Angeles", "Houston", "New York"],
    answer: 3
}];
